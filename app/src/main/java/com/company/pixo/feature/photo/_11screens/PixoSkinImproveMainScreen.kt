...
fun PixoSkinImproveMainScreen(
   ...
   ToolPhotoSourceScreen(
        ...
        beforeImageRes = R.drawable.tools_skin_improve1,
        afterImageRes = R.drawable.tools_skin_improve2,
...
@Preview(
    name = "Pixo / Skin Improve Main Screen",
    showBackground = true,
    widthDp = 390,
    heightDp = 844
)
@Composable
private fun PixoSkinImproveMainScreenPreview() {
    PixoTheme {
